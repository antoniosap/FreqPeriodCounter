...
float FreqPeriodCounter::hertzf(unsigned int precision)
{ if (timeFunctionPtr == micros) return (unsigned long)precision*1000000.0/period;
  else return (float)precision*1000.0/period;
}
